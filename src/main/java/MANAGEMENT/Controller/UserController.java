...
public class UserController extends Login {
    ...
    public static void SessionLogin() {
        ...
        while (true) {
                    ...
                    System.out.println("nhap 4 la nhap thong tin phieu nhap");
                    System.out.println("nhap 5 la nhap thong tin phieu xuat");
                    //System.out.println("nhap 6 la doc thong tin user");
